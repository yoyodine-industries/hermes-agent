---
name: stocks
description: Use when you need quotes, history, or crypto from Yahoo.
version: 0.1.0
...
Reads stock quotes, history, symbol search, comparison and crypto data via Yahoo Finance.
