...
_LATER_TASK_COLUMNS = (
    ...
    ("skills", "skills TEXT"),
    # JSON array of canonical toolset names this card's worker must carry; refused
    # at create/assign when the assignee lane's platform_toolsets.cli lacks them.
    ("requires_toolsets", "requires_toolsets TEXT"),
